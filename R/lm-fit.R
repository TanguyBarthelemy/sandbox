...
df <- structure(list(y = c(1.51156139, -0.63653132, 0.37782776, 3.03792318,
...
lm(y~x,data=df)
print(max(resid(lm(y~x,data=df))))
print(max(resid(lm(y~x,data=df,weights=df$weights))))


fit <- lm(y~x,data=df,weights=df$weight)
print(min(predict(fit) - fitted(fit)))
